...
def init_model_and_shard(
    ...
    if with_ddp and not with_fsdp:
        ...
        # reshard_after_forward=False keeps FE parameters unsharded during the
        # multi-step rollout loop. Needed for pushforward trick.
        _shard_modules(
            model.forecast_engine.fe_blocks, {**fsdp_kwargs, "reshard_after_forward": False}
        )
