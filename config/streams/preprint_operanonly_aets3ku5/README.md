# Stream set for the PREPRINT OPERAN-ONLY precipitation experiment on backbone `aets3ku5`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_aets3ku5/, so the encoder
