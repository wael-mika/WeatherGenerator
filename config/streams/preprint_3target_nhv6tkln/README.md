# Stream set for the PREPRINT 3-TARGET precipitation experiment on backbone `nhv6tkln`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_nhv6tkln/ -- the
