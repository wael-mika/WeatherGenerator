# Stream set for the PREPRINT 3-TARGET precipitation experiment on backbone `aets3ku5`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_aets3ku5/ -- the
