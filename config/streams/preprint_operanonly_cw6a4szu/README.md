# Stream set for the PREPRINT OPERAN-ONLY precipitation experiment on backbone `cw6a4szu`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_cw6a4szu/, so the encoder
