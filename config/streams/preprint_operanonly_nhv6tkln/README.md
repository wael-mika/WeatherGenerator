# Stream set for the PREPRINT OPERAN-ONLY precipitation experiment on backbone `nhv6tkln`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_nhv6tkln/, so the encoder
