# Stream set for the PREPRINT 3-TARGET precipitation experiment on backbone `cw6a4szu`.
#
# Forcing/input streams are copied VERBATIM from config/streams/imerg_diag_cw6a4szu/ -- the
